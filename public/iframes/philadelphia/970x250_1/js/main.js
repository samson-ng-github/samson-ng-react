...
var loader = new WASTE.Loader([
	"assets/bg.jpg", "assets/t1.png", "assets/pot_olive.png", "assets/pot_blue.png", "assets/pot_green.png",
...
function onAssetsReady()
{
	...
	timeline.addParam(b1, {y: 0}, 5, false);
	timeline.addParam(b2, {y: 27}, 5+0.5, false);
	timeline.addParam(b3, {y: 9}, 5+0.5*2, false);
	timeline.addParam(b4, {y: 28}, 5+0.5*3, false);
	timeline.addParam(b5, {y: 9}, 5+0.5*4, false);
