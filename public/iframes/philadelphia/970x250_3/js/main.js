...
var loader = new WASTE.Loader([
	"assets/bg.jpg", "assets/t1.png", "assets/pot_green.png", "assets/pot_olive.png", "assets/pot_blue.png",
	"assets/b1.png", "assets/b2.png", "assets/b3.png", "assets/b4.png", "assets/b5.png", "assets/leaf.png", "assets/t2.png",
...
function onAssetsReady()
{
	...
	var leaf = new WASTE.Sprite(10);
	stage.addChild(leaf);

	var t2 = new WASTE.Sprite(11);
	stage.addChild(t2);
	
	var cta1 = new WASTE.Sprite(12);
	stage.addChild(cta1);
	var cta2 = new WASTE.Sprite(13);
	stage.addChild(cta2);
	...
	timeline.addParam(b1, {y: 7}, 5, false);
	timeline.addParam(b2, {y: 7}, 5+0.5, false);
	timeline.addParam(b3, {y: 7}, 5+0.5*2, false);
	timeline.addParam(b4, {y: 7}, 5+0.5*3, false);
	timeline.addParam(b5, {y: canvas_h}, 5+0.5*4, false);
	timeline.addParam(leaf, {y: 234}, 5+0.5, false);
	...
	timeline.addTween(leaf, 0.25, {y: 234+canvas_h}, 9, false, "easeOut");
