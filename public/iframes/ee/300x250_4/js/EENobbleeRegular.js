(function(window) {
	...
	EENobbleeRegular = function() {
		...
		this.$i = [[4.8,10.4],[4.8,15.84],[4.8,18.03],[4.8,20.23],[4.8,22.43],[4.8,24.62],[4.8,26.82],[4.8,29.02]];
		this.$h = [[4.8,9.69],[4.8,11.84],[4.8,13.99],[4.8,16.14],[4.8,18.28],[4.8,20.43],[4.8,22.58],[4.8,24.72],[4.8,26.87],[4.8,29.06],[6.69,17.09],[8.65,15.90],[10.88,15.63],[13.05,16.25],[14.64,17.95],[15.18,20.10],[15.18,22.33],[15.18,24.56],[15.18,26.79],[15.18,29.02]];
		this.$o = [[4.2,21.26],[4.89,19.04],[6.33,17.21],[8.30,16.05],[10.61,15.72],[12.89,16.05],[14.92,17.21],[16.30,19.04],[16.99,21.26],[4.2,23.56],[4.89,25.78],[6.33,27.58],[8.30,28.75],[10.61,29.08],[12.89,28.75],[14.92,27.58],[16.30,25.78],[16.99,23.56]];
		this.$n = [[4.8,29.09],[4.8,26.84],[4.8,24.59],[4.8,22.35],[4.8,20.10],[4.8,17.85],[6.45,16.30],[8.65,15.70],[10.91,15.73],[13.13,16.34],[14.67,17.96],[15.2,20.14],[15.2,22.38],[15.2,24.62],[15.2,26.85],[15.2,29.09]];
		this.$e = [[14.03,28.52],[11.72,29.05],[9.43,29.05],[7.23,28.24],[5.43,26.74],[4.46,24.67],[4.22,22.43],[4.44,20.22],[5.35,18.17],[6.88,16.54],[8.95,15.76],[11.14,15.70],[13.28,16.48],[14.82,18.08],[15.54,20.25],[15.33,22.45],[13.26,22.45],[11,22.45],[8.74,22.45],[6.48,22.45]];
		...
		this.getSize = function(char) {
			...
			switch (char)
			{
				...
				case "i" :
					rect = new createjs.Rectangle(0, 0, 7.8, 39);
					break;
				case "h" :
					rect = new createjs.Rectangle(0, 0, 18.18, 39);
					break;
				case "o":
					rect = new createjs.Rectangle(0, 0, 19.39, 39);
					break;
				case "n":
					rect = new createjs.Rectangle(0, 0, 18.2, 39);
					break;
				case "e":
					rect = new createjs.Rectangle(0, 0, 17.92, 39);
					break;
			}
			return rect;
		}
