...
(lib.PhonePNG = function(mode,startPosition,loop) {
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
...
if (loop == null) { loop = false; }	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance}/*,{t:this.ctaButton}*/]}).wait(0));

	
	//Phone
	this.Phone = new lib.PhonePNG();
	this.Phone.setTransform(0,0,1,1);
	//this.ParticlesStatic.alpha = 0.699;
	this.timeline.addTween(cjs.Tween.get(this.Phone).wait(0));
	
	// Layer 6
	this.tickerHolder = new lib.TickerHolder();
	this.timeline.addTween(cjs.Tween.get(this.tickerHolder).wait(0));
	...
	//this.ParticlesStatic.alpha = 0.699;
	this.timeline.addTween(cjs.Tween.get(this.ParticlesStatic).wait(0));
	...
	this.timeline.addTween(cjs.Tween.get(this.bg).wait(0));
