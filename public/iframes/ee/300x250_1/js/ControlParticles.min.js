! function(window) {
    ...
    _p.generate = function() {
        ...
        for (var newPoint = new createjs.Point, i = 0; i < this._circlesArray.length - density; i += density) {
		...
		TweenLite.to(this._circlesArray[this._circlesArray.length-1], t, {
        	x: firstPoint.x,
            y: firstPoint.y,
            delay: Math.random()*t,
            ease: Elastic.backIn
