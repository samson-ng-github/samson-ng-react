...
function init(){
    ...
    if (!Enabler.isInitialized()) {
        ...
        function enablerInitialized() {
            ...
            devDynamicContent.Feed_160x600[0].reporting_label = "Reporting label";
            ...
            devDynamicContent.Feed_160x600[0].CTA = "Find out\nmore";
            ...
            devDynamicContent.Feed_160x600[0].legalsButton = "Click for legals";
            devDynamicContent.Feed_160x600[0].legalsCopy = "<strong>Lorem</strong> Ipsum";
            devDynamicContent.Feed_160x600[0].clickthrough = "http://www.sky.com/shop/sky-bundles/";
            devDynamicContent.Feed_160x600[0].frame4Option = true;
            ...
            data = dynamicContent.Feed_160x600[0];
        }
}
...
function prepAssets(){
    ...
    for (var key in dynamicContent.Feed_160x600[0].content){
        var obj = {};
        obj.id = key;
        obj.src = dynamicContent.Feed_160x600[0].content[key]['Url'];
        manifest.push(obj);
    }
...
/*Frame1*/
    ...
    frame1_Copy1.regY = 461 * 0.5;
    frame1_Copy1.x = canvas.width * 0.5;
    frame1_Copy1.y = 461 * 0.5;
    ...
    frame1_Copy2.regY = 461 * 0.5;
    frame1_Copy2.x = canvas.width * 0.5;
    frame1_Copy2.y = 461 * 0.5;
...
function frame_2()
{
    TweenLite.to(peelShape1, .1, {delay:0.3,y:canvas.height - 15,  ease:Cubic.easeIn, overwrite:0});
    TweenLite.to(movieClip1, 1.3, {delay:0.3,y:-canvas.height + 15,  ease:Cubic.easeIn, overwrite:0});
    TweenLite.to(movieClip2, 1.3, {delay:0.3,y:0,  ease:Cubic.easeIn, overwrite:0});
...
function frame_3()
{
    ...
    TweenLite.to(frame3_Copy, 0, {delay:3.5,alpha:0, ease:Cubic.easeOut});
    //TweenLite.to(skylogoWhite, 0, {delay:4,alpha:1});

    TweenLite.to(movieClip1, 0.2, {delay:3.5,alpha:0,y:-canvas.height,ease:Cubic.easeOut, overwrite:0,onStart:function(){
...
function frame_4()
{
    ...
    TweenLite.to(movieClip2, 1, {delay:0.3,y: -canvas.height + 277, ease:Cubic.easeOut, overwrite:0});
    ...
    //TweenLite.to(peelShape2, .2, {delay:0.3,y:467 - 10,ease:Cubic.easeOut, overwrite:0});

    TweenLite.delayedCall(1.5,function(){
         TweenLite.to(movieSetHolder, 3, {x:-678,  ease:Quad.easeOut, overwrite:0});
         TweenLite.to(movieSetHolder, 0.5, {delay:3, x:-678,  ease:Quad.easeIn, overwrite:0});
    })
...
function frame_5()
{
    ...
    TweenLite.to(movieClip2, .75, {y:-canvas.height,  ease:Cubic.easeIn, overwrite:0});
    TweenLite.to(BG_f4, .75, {y:canvas.height,  ease:Cubic.easeIn, overwrite:0});

    TweenLite.to(movieSet, 1.5, {delay:0.5, scaleX:1.667, scaleY:1.667, y: 300, ease:Back.easeOut.config(2), overwrite:0});
    TweenLite.to([frame5_Copy1, frame5_Copy2], 1.5, {delay:0.5, scaleX:1, scaleY:1, y: 300, ease:Back.easeOut.config(2), overwrite:0, onStart:function(){
    ...
    cta = new SkyCta(dynamicContent.Feed_160x600[0].CTA, fontName, false, ctaGradient, "rgba(255,255,255,0.6)" );
    cta.x = canvas.width * 0.5;
    cta.y = canvas.height * 0.7;
    cta.alpha = 0;
    stage.addChild(cta);
    ...
    stage.update();
     ...
     function(){
        ...
        TweenLite.to(glean, 1, {x:'+=44'});
        TweenLite.to(glean1, .2, {alpha:1});
        TweenLite.to(glean1, 1, {x:'-=44',onStart:function(){
...
// EXIT:
function onCtaClick(){
     Enabler.exit('clickThrough', dynamicContent.Feed_160x600[0].clickthrough);
}
...
    var backgroundGradPath = ["AlmkrILNAAQBaAAAABYIAAGlQAABahaAAIrNAAQhaAAAAhaIAAmlQAAhYBaAAg",
        "An8CRQhLgBAAhKIAAiKQAAhMBLABIP5AAQBMgBAABMIAACKQAABKhMABg"
    ];
    var highlightGradPath = ["AmgADIgggTQgBg7AjgVQATgLAlAAILNAAQAvADARAOQAZAVACA/IgUAJQivBpj5AAQj3AAivhpg",
        "An8CRQhLgBAAhKIAAiKQAAhMBLABIP5AAQBMgBAABMIAACKQAABKhMABg"
    ];
