...
var clickTag = "http://bt.com/businessmoments/";
...
function setupBanner() {
  ...
  BT.banner.BTvideo.cta   = document.getElementById('cta');
...
function startBanner() {
  ...
  TweenMax.to(BT.banner.BTvideo.cta, 0, {alpha:0});
  ...
  if ((navigator.userAgent.match(/iPhone/i)) ||
    ...
    BT.autoplay = false;
    /*setTimeout(function() {
    	tlM.to('#PLAY-iPad', 0, {autoAlpha:1, ease: Sine.easeIn});
    }, 1500);*/
	BT.banner.BTvideo.vidPlayBtniPad.style.visibility  = 'visible'; 
...
function exitClickHandler() {
  ...
  if (BT.banner.BTvideo.vid.readyState > 0) {BT.banner.BTvideo.vid.currentTime = 30 - 0.5;}
  ...
  TweenMax.to(BT.banner.BTvideo.cta, 0.1, {alpha:1});
...
function stopHandler(e) {
  ...
  BT.banner.BTvideo.vid.currentTime = 30 - 0.5;
  BT.banner.BTvideo.vid.pause();
  TweenMax.to(BT.banner.BTvideo.vidPauseBtn, 0.1, {alpha:0});
  TweenMax.to(BT.banner.BTvideo.vidPlayBtn, 0.1, {alpha:1});
  TweenMax.to(BT.banner.BTvideo.cta, 0.1, {alpha:1});
...
function replayBannerHandler(e) {
  ...
  TweenMax.to(BT.banner.BTvideo.vidPauseBtn, 0.1, {alpha:1});
  TweenMax.to(BT.banner.BTvideo.vidPlayBtn, 0.1, {alpha:0});
  TweenMax.to(BT.banner.BTvideo.cta, 0.1, {alpha:0});
